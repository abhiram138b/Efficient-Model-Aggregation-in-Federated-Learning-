...
def sparsify_flatten(w, s):
    """
    Sparsifies array by retrieving (s) fraction of values with the highest 
...
def golomb_encode(vals, s):
    ...
    number of bits per value using sparsity s, into a bitarray object.
...
def golomb_decode(bits, bstar):
    """
    Decode golomb-encoded bitarray into 1D integer array. 
