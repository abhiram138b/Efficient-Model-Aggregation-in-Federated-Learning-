...
class FedAvgModel(Model):
    ...
    atedel and optimizer weights, and training/testing within FedAvg
...
class MNIST2NNModel(FedAvgModel):
    ...
    def __init__(self, optimizer, loss_calc, in_size, outputs):
        ...
        #convolutional layers,max-pooling layers and dense layers
...
class CIFARCNNModel(FedAvgModel):
    ...
    #CNN,normalization layers('BatchNormalization'),dropout layers('Dropout'),and dense layers
    
#The training process uses stochastic gradient descent (SGD) with the specified optimizer and loss function.